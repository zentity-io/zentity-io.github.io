...
`elasticsearch-plugin install https://zentity.io/releases/zentity-1.0.3-elasticsearch-6.7.0.zip`
...
`elasticsearch-plugin install file:///path/to/zentity-1.0.3-elasticsearch-6.7.0.zip`
