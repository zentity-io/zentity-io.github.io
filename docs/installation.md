...
`elasticsearch-plugin install https://zentity.io/releases/zentity-0.4.0-beta.1-elasticsearch-6.2.4.zip`
...
`elasticsearch-plugin install file:///path/to/zentity-0.4.0-beta.1-elasticsearch-6.2.4.zip`
