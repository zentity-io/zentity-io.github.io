...
`elasticsearch-plugin install https://zentity.io/releases/zentity-0.1.1-beta.1-elasticsearch-6.2.3.zip`
...
`elasticsearch-plugin install file:///path/to/zentity-0.1.1-beta.1-elasticsearch-6.2.3.zip`
